...
export type Kpi48h = Database['public']['Tables']['kpi_48h']['Row']
export type RevenueMonthly = Database['public']['Tables']['revenue_monthly']['Row']
export type RiskMonthly = Database['public']['Tables']['risk_monthly']['Row']
export type Sustainability = Database['public']['Tables']['sustainability']['Row']
export type LearningFeedback = Database['public']['Tables']['learning_feedback']['Row']
export type QuotaDaily = Database['public']['Tables']['quota_daily']['Row']
