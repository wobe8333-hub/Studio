...
def run_v85_variant_builder(v8_root: Path, run_id: str) -> None:
    ...
    print("[V8.5] title variants done count=3")

    print("[V8.5] thumbnail variants start")
    ...
    print("[V8.5] thumbnail variants done count=3")
    ...
    print(f"[V8.5] variant manifest saved path={manifest_path}")
    print("[V8.5] complete")
